...
export const VIEW_DOWNLOAD_PROGRESS = 'VIEW_DOWNLOAD_PROGRESS'
export const GET_MULTI_MONITOR_MODE = 'GET_MULTI_MONITOR_MODE'
export const SET_MULTI_MONITOR_MODE = 'SET_MULTI_MONITOR_MODE'
